...
x_valid = valid_data["spectrograms"]
...
cnn = Conv2D(32, kernel_size=(5, 5), strides=(1, 1), activation='relu')(x11)
cnn = MaxPooling2D(pool_size=(2, 2))(cnn)
cnn = Conv2D(64, kernel_size=(5, 5), strides=(1, 1), activation='relu')(cnn)
cnn = MaxPooling2D(pool_size=(2, 2))(cnn)

cnn = Flatten()(cnn)
intermedia_output = Dense(1024, activation="relu", name="intermedia_output")(cnn)
